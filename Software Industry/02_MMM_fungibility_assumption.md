...
The team-size evidence comes from **two distinct studies with different datasets and methodological status — they should be cited separately, not merged into one "analysis of over 1,000 projects"** (correction 2026-06-27; see `08_CITATIONS_gap_closure.md` Gap 4). (1) **Rodríguez et al. (2012)**, *Journal of Systems and Software* (peer-reviewed; 951 high-quality instances preprocessed from ISBSG Release 10), found that **teams of 9 or more exhibit significantly lower productivity**. (2) **Putnam (1997)**, a QSM industry article (not peer-reviewed; 491 projects from the QSM database), found **3–5 the best-performing size, with 5–7 a close second**. The earlier "1,000+ projects / 3–5 optimal / 9+ degrades" phrasing conflated the two (and slightly overstated Rodríguez's 951 as "1,000+").

Taken together — with the methodological caveat that the "small is optimal" number is the weaker (non-peer-reviewed) source while the "large degrades" number is peer-reviewed — the direction is consistent and long-observed: optimal software team size is small (roughly 3–7), and beyond ~9 coordination overhead consumes the productivity gains from additional headcount.
